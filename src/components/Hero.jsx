...
const Hero = ({ isDarkMode }) => {
    ...
    return (
        // PERBAIKAN: Gunakan min-h-screen untuk memastikan tinggi minimal satu layar penuh
        <section 
            id="home" 
            className="hero min-h-screen flex flex-col items-center justify-center pt-24 pb-12 text-center relative z-10 overflow-hidden"
        >
            <motion.div
                initial="hidden"
                animate="visible"
                variants={containerVariants}
                className="container mx-auto px-6 max-w-4xl flex-grow flex flex-col items-center justify-center"
            >
